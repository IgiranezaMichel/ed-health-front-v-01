                    ...
                    <div className="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md " role="document" >
                        <div className="modal-content rounded-0 bg-white ">
                            ...
                            <div className="overflow-auto">
                                <div className=" p-3">
                                    <TextField value={training.title} id="outlined-basic" className="form-control mb-3" label="Title" variant="standard"
                                    ...
                                    <span className="fw-bold mb-3">Deadline</span>
                                    <TextField id="outlined-basic" value={training.deadline} onChange={(e) => { setTraining({ ...training, deadline: e.target.value })}} type="datetime-local" className="form-control mb-3" variant="standard" />
                                    <div className="mb-3">
                                    ...
                                    <label htmlFor="" className="fw-bold">Training Requirement</label>
                                    <JoditEditor onChange={(text) => setTraining({ ...training, trainingRequirement: text })} value="Specify Requirement"></JoditEditor>
                                </div>
                            </div>
